...
from boiler_heat_exchanger_2D_rev2 import \
...
def build_unit():
    ...
    m.fs.unit = HeatExchangerCrossFlow2D_Header(default={
                               ...
                               "estimate_allowable_cycles": False})

    # Primary Superheater (NETL baseline report)
    ITM = 0.0254  # inch to meter conversion
    m.fs.unit.tube_di.fix(0.035)
    m.fs.unit.tube_thickness.fix(0.0035)
