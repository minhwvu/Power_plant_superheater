...
def main_dyn():
    ...
    plot_data['PSH_temp_wall_tube_disc3'] = []
    plot_data['PSH_temp_wall_tube_disc4'] = []
    plot_data['PSH_temp_wall_tube_disc5'] = []
    plot_data['PSH_temp_wall_tube_disc6'] = []
    plot_data['PSH_temp_wall_tube_disc7'] = []
    ...
    plot_data['PSH_von_Mises_inside_disc3'] = []
    plot_data['PSH_von_Mises_inside_disc4'] = []
    plot_data['PSH_von_Mises_inside_disc5'] = []
    plot_data['PSH_von_Mises_inside_disc6'] = []
    plot_data['PSH_von_Mises_inside_disc7'] = []
...
def run_dynamic(m, x0, t0, pd, solver):
    ...
    # number of elements along the tube for PSH
    n_element = m.fs_main.fs_blr.aPSH.config.finite_elements
    # append results
    for t in m.fs_main.config.time:
        ...
        pd['PSH_flue_gas_flow_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, round(2/n_element,6)].flow_mol))
        pd['PSH_flue_gas_flow_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, round(4/n_element,6)].flow_mol))
        pd['PSH_flue_gas_flow_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, round(8/n_element,6)].flow_mol))
        ...
        pd['PSH_steam_flow_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, round(2/n_element,6)].flow_mol))
        pd['PSH_steam_flow_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, round(4/n_element,6)].flow_mol))
        pd['PSH_steam_flow_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, round(8/n_element,6)].flow_mol))
        ...
        pd['PSH_temp_wall_tube_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(2/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_temp_wall_tube_disc3'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(3/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_temp_wall_tube_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(4/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_temp_wall_tube_disc5'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(5/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_temp_wall_tube_disc6'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(6/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_temp_wall_tube_disc7'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(7/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_temp_wall_tube_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(8/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        ...
        pd['PSH_temp_wall_shell_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(2/n_element,6), m.fs_main.fs_blr.aPSH.r.last()]))
        pd['PSH_temp_wall_shell_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(4/n_element,6), m.fs_main.fs_blr.aPSH.r.last()]))
        pd['PSH_temp_wall_shell_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube_wall_temperature
                      [t, round(8/n_element,6), m.fs_main.fs_blr.aPSH.r.last()]))
        ...
        pd['PSH_temp_wall_shell_fouling_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell_wall_temperature
                      [t, round(2/n_element,6)]))
        pd['PSH_temp_wall_shell_fouling_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell_wall_temperature[t, round(4/n_element,6)]))
        pd['PSH_temp_wall_shell_fouling_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell_wall_temperature
                      [t, round(8/n_element,6)]))
        ...
        #print vM stress for 9 elements
        ...
        pd['PSH_von_Mises_inside_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_von_Mises
                      [t, round(2/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_von_Mises_inside_disc3'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_von_Mises
                      [t, round(3/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_von_Mises_inside_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_von_Mises
                      [t, round(4/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_von_Mises_inside_disc5'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_von_Mises
                      [t, round(5/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_von_Mises_inside_disc6'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_von_Mises
                      [t, round(6/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_von_Mises_inside_disc7'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_von_Mises
                      [t, round(7/n_element,6), m.fs_main.fs_blr.aPSH.r.first()]))
...
def write_data_to_txt_file(plot_data):
    ...
    icount = 0
    with open("case2_10pct_result.txt","w") as fout:
        # write headings
        for k in plot_data:
            icount += 1
            fout.write(k)
