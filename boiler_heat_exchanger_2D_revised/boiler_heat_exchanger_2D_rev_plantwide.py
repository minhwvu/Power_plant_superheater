...
@declare_process_block_class("HeatExchangerCrossFlow2D_Header_rev")
class HeatExchangerCrossFlow2D_Header_revData(UnitModelBlockData):
...
tube side flows from 1 to 0"""))
    ...
    def build(self):
        ...
        super(HeatExchangerCrossFlow2D_Header_revData, self).build()
    ...
    def _make_performance(self):
        ...
        def mean_temperature(b, t, x):
            return 2 * (b.r[2]-b.r[1]) * b.r_scaling**2 / (b.tube_ro**2
                                                            - b.tube_ri**2) * \
        ...
        def discrete_mean_temperature(b, t, x, r):
            if b.rindex[r].value == 1:
                ...
                return 2 * (b.r[2] - b.r[1]) * b.r_scaling**2 \
                    / ((b.r[b.rindex[r].value] * b.r_scaling)**2
                       - b.tube_ri**2) *\
                    (sum(0.5 * (b.r[j-1] *
        ...
        if self.config.has_header is True:
            ...
            def rupture_time_crotch_corner(b, t):
                if value(b.sigma_eff_P1[t]) > 10:  # MPa
                    return 10**((b.creep_a_header + b.creep_b_header
