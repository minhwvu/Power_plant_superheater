...
import flowsheets.boiler_subfs_reheater2 as blr
...
def main_dyn():
    ...
    plot_data['drum_inner_theta_sigma'] = []
    plot_data['drum_inner_vM_sigma'] = []
    plot_data['drum_outer_theta_sigma_m'] = []
    plot_data['drum_outer_theta_sigma_t'] = []
    plot_data['drum_outer_theta_sigma'] = []
    plot_data['drum_outer_radial_sigma'] = []
    plot_data['drum_outer_axial_sigma'] = []
    ...
    plot_data['PSH_ther_circumferential_outside_disc2'] = []
    plot_data['PSH_ther_circumferential_outside_disc4'] = []
    plot_data['PSH_ther_circumferential_outside_disc8'] = []
    plot_data['PSH_ther_circumferential_outside_disc9'] = []
    ...
    # for reheater
    plot_data['pres_fg_RH2_in'] = []
    plot_data['pres_RH2_in'] = []
    plot_data['RH2_flue_gas_flow_disc1'] = []
    plot_data['RH2_flue_gas_flow_disc2'] = []
    plot_data['RH2_steam_flow_disc1'] = []
    plot_data['RH2_steam_flow_disc2'] = []
    plot_data['RH2_steam_temperature_disc1'] = []
    plot_data['RH2_steam_temperature_disc2'] = []
    plot_data['RH2_temp_wall_tube_disc1'] = []
    plot_data['RH2_temp_wall_tube_disc2'] = []
    plot_data['RH2_temp_wall_shell_disc1'] = []
    plot_data['RH2_temp_wall_shell_disc2'] = []
    plot_data['RH2_temp_wall_shell_fouling_disc1'] = []
    plot_data['RH2_temp_wall_shell_fouling_disc2'] = []
    plot_data['RH2_flue_gas_temperature_disc1'] = []
    plot_data['RH2_flue_gas_temperature_disc2'] = []
    plot_data['RH2_von_Mises_inside_disc1'] = []
    plot_data['RH2_von_Mises_inside_disc2'] = []
    plot_data['RH2_delta_s12_inside_disc1'] = []
    plot_data['RH2_delta_s23_inside_disc1'] = []
    plot_data['RH2_delta_s31_inside_disc1'] = []
    plot_data['RH2_mech_circumferential_inside_disc1'] = []
    plot_data['RH2_ther_circumferential_inside_disc1'] = []
    plot_data['RH2_circumferential_inside_disc1'] = []
    plot_data['RH2_mech_circumferential_outside_disc1'] = []
    plot_data['RH2_ther_circumferential_outside_disc1'] = []
    plot_data['RH2_circumferential_outside_disc1'] = []
    plot_data['RH2_ther_circumferential_inside_disc2'] = []
    plot_data['RH2_ther_circumferential_outside_disc2'] = []

    # For reheater2 header
    plot_data['RH2_header_inner_temperature'] = []
    plot_data['RH2_header_outside_temperature'] = []
    plot_data['RH2_header_circumferential_P1'] = []
    plot_data['RH2_header_circumferential_P2'] = []
    plot_data['RH2_header_circumferential_body'] = []
    plot_data['RH2_header_von_Mises_P1'] = []
    plot_data['RH2_header_von_Mises_P2'] = []
    plot_data['RH2_header_rupture_time_P1'] = []
    plot_data['RH2_header_rupture_time_P2'] = []
    ...
    itype_list = []
    for i in range(1): # to 1860 sec #31
        itype_list.append(0)
    # number of periods
    for i in range(1): # to 4260 sec #20
        itype_list.append(1)
    for i in range(1): # to 6060 sec #30
        itype_list.append(0)
...
def run_dynamic(m, x0, t0, pd, solver):
    ...
    for t in m.fs_main.config.time:
        ...
        pd['drum_temp'].append(pyo.value(
            m.fs_main.fs_blr.aDrum.control_volume.properties_in[t].temperature))
        ...
        pd['drum_inner_theta_sigma_t'].append(
            pyo.value(m.fs_main.fs_blr.aDrum.therm_sigma_theta
                      [t, m.fs_main.fs_blr.aDrum.radial_domain.first()]))
        pd['drum_inner_theta_sigma'].append(
            pyo.value(m.fs_main.fs_blr.aDrum.sigma_theta
                      [t, m.fs_main.fs_blr.aDrum.radial_domain.first()]))
        ...
        pd['drum_outer_theta_sigma_t'].append(
            pyo.value(m.fs_main.fs_blr.aDrum.therm_sigma_theta
                      [t, m.fs_main.fs_blr.aDrum.radial_domain.last()]))
        pd['drum_outer_theta_sigma'].append(
            pyo.value(m.fs_main.fs_blr.aDrum.sigma_theta
                      [t, m.fs_main.fs_blr.aDrum.radial_domain.last()]))
        pd['drum_outer_radial_sigma'].append(
            pyo.value(m.fs_main.fs_blr.aDrum.sigma_r
                [t, m.fs_main.fs_blr.aDrum.radial_domain.last()]))
        pd['drum_outer_axial_sigma'].append(
            pyo.value(m.fs_main.fs_blr.aDrum.sigma_z
                [t, m.fs_main.fs_blr.aDrum.radial_domain.last()]))
        ...
        # For primary superheater
        pd['pres_fg_PSH_in'].append(
            m.fs_main.fs_blr.aPSH.shell_inlet.pressure[t].value)
        pd['pres_PSH_in'].append(
        ...
        pd['PSH_flue_gas_flow_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, 0.166667].flow_mol))
        pd['PSH_flue_gas_flow_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, 0.5].flow_mol))
        pd['PSH_flue_gas_flow_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, 0.666667].flow_mol))
        pd['PSH_flue_gas_flow_disc9'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.shell.properties[t, 1].flow_mol))
        pd['PSH_steam_flow_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, 0].flow_mol))
        pd['PSH_steam_flow_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, 0.166667].flow_mol))
        pd['PSH_steam_flow_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, 0.5].flow_mol))
        pd['PSH_steam_flow_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.tube.properties[t, 0.666667].flow_mol))
        ...
        pd['PSH_circumferential_outside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_theta
                      [t, 0, m.fs_main.fs_blr.aPSH.r.last()]))
        pd['PSH_ther_circumferential_inside_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 0.166667, m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_ther_circumferential_inside_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 0.5, m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_ther_circumferential_inside_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 0.666667, m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_ther_circumferential_inside_disc9'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 1, m.fs_main.fs_blr.aPSH.r.first()]))
        pd['PSH_ther_circumferential_outside_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 0.166667, m.fs_main.fs_blr.aPSH.r.last()]))
        pd['PSH_ther_circumferential_outside_disc4'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 0.5, m.fs_main.fs_blr.aPSH.r.last()]))
        pd['PSH_ther_circumferential_outside_disc8'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 0.5, m.fs_main.fs_blr.aPSH.r.last()]))
        pd['PSH_ther_circumferential_outside_disc9'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.therm_sigma_theta
                      [t, 1, m.fs_main.fs_blr.aPSH.r.last()]))

        # For primary superheater header
        pd['PSH_header_inner_temperature'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.header_wall_temperature
                      [t, m.fs_main.fs_blr.aPSH.head_r.first()]))
        pd['PSH_header_outside_temperature'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.header_wall_temperature
                      [t, m.fs_main.fs_blr.aPSH.head_r.last()]))
        pd['PSH_header_circumferential_P1'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_theta_P1[t]))
        pd['PSH_header_circumferential_P2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_theta_P2[t]))
        pd['PSH_header_circumferential_body'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_theta_header
                      [t, m.fs_main.fs_blr.aPSH.head_r.first()]))
        pd['PSH_header_von_Mises_P1'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_eff_P1[t]))
        pd['PSH_header_von_Mises_P2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.sigma_eff_P2[t]))
        pd['PSH_header_rupture_time_P1'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.rupture_time_crotch_corner[t]))
        pd['PSH_header_rupture_time_P2'].append(
            pyo.value(m.fs_main.fs_blr.aPSH.rupture_time_P2[t]))

        # for reheater 2
        pd['pres_fg_RH2_in'].append(
            m.fs_main.fs_blr.aRH2.shell_inlet.pressure[t].value)
        pd['pres_RH2_in'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube
                      .properties[t, 1].pressure))
        pd['RH2_flue_gas_flow_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.shell.properties[t, 0].flow_mol))
        pd['RH2_flue_gas_flow_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.shell.properties[t, 1].flow_mol))
        pd['RH2_steam_flow_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube.properties[t, 0].flow_mol))
        pd['RH2_steam_flow_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube.properties[t, 1].flow_mol))
        pd['RH2_steam_temperature_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube.properties[t, 0].temperature))
        pd['RH2_steam_temperature_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube
                      .properties[t, 1].temperature))
        pd['RH2_temp_wall_tube_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube_wall_temperature
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_temp_wall_tube_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube_wall_temperature
                      [t, 1, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_temp_wall_shell_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube_wall_temperature
                      [t, 0, m.fs_main.fs_blr.aRH2.r.last()]))
        pd['RH2_temp_wall_shell_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.tube_wall_temperature
                      [t, 1, m.fs_main.fs_blr.aPSH.r.last()]))
        pd['RH2_temp_wall_shell_fouling_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.shell_wall_temperature[t, 0]))
        pd['RH2_temp_wall_shell_fouling_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.shell_wall_temperature
                      [t, 1]))
        pd['RH2_flue_gas_temperature_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.shell
                      .properties[t, 0].temperature))
        pd['RH2_flue_gas_temperature_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.shell
                      .properties[t, 1].temperature))
        pd['RH2_von_Mises_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_von_Mises
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_von_Mises_inside_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_von_Mises
                      [t, 1, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_delta_s12_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.delta_sigma_r_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_delta_s23_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.delta_sigma_theta_z
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_delta_s31_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.delta_sigma_z_r
                      [t, 0, m.fs_main.fs_blr.aPSH.r.first()]))
        pd['RH2_mech_circumferential_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.mech_sigma_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_ther_circumferential_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.therm_sigma_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_circumferential_inside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_mech_circumferential_outside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.mech_sigma_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.last()]))
        pd['RH2_ther_circumferential_outside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.therm_sigma_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.last()]))
        pd['RH2_circumferential_outside_disc1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_theta
                      [t, 0, m.fs_main.fs_blr.aRH2.r.last()]))
        pd['RH2_ther_circumferential_inside_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.therm_sigma_theta
                      [t, 1, m.fs_main.fs_blr.aRH2.r.first()]))
        pd['RH2_ther_circumferential_outside_disc2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.therm_sigma_theta
                      [t, 1, m.fs_main.fs_blr.aPSH.r.last()]))

        # for reheater2 header
        pd['RH2_header_inner_temperature'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.header_wall_temperature
                      [t, m.fs_main.fs_blr.aRH2.head_r.first()]))
        pd['RH2_header_outside_temperature'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.header_wall_temperature
                      [t, m.fs_main.fs_blr.aRH2.head_r.last()]))
        pd['RH2_header_circumferential_P1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_theta_P1[t]))
        pd['RH2_header_circumferential_P2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_theta_P2[t]))
        pd['RH2_header_circumferential_body'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_theta_header
                      [t, m.fs_main.fs_blr.aRH2.head_r.first()]))
        pd['RH2_header_von_Mises_P1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_eff_P1[t]))
        pd['RH2_header_von_Mises_P2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.sigma_eff_P2[t]))
        pd['RH2_header_rupture_time_P1'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.rupture_time_crotch_corner[t]))
        pd['RH2_header_rupture_time_P2'].append(
            pyo.value(m.fs_main.fs_blr.aRH2.rupture_time_P2[t]))
...
def write_data_to_txt_file(plot_data):
    ...
    icount = 0
    with open("case1_5pct_result.txt","w") as fout:
        # write headings
        for k in plot_data:
            icount += 1
            fout.write(k)
